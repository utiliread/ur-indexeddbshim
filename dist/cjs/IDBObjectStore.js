    ...
    function IDBObjectStore() {
        ...
        Object.defineProperty(this, 'name', {
            ...
            set: function (name) {
                ...
                IDBTransaction_1.default.__assertVersionChange(me.transaction);
                ...
                me.transaction.__addNonRequestToTransactionQueue(function objectStoreClear(tx, args, success, error) {
                    tx.executeSql(sql, sqlValues, function (tx, data) {
                        ...
                        CFG_1.default.DEBUG && console.log(sql);
...
IDBObjectStore.__deleteObjectStore = function (db, store) {
    ...
    store.__indexNames = DOMStringList_1.default.__createInstance();
    ...
    if (storeHandle) {
        storeHandle.__indexNames = DOMStringList_1.default.__createInstance();
...
IDBObjectStore.prototype.__insertData = function (tx, encoded, value, clonedKeyOrCurrentNumber, oldCn, success, error) {
    ...
    return sync_promise_1.default.all(indexPromises).then(function () {
        ...
        CFG_1.default.DEBUG && console.log('SQL for adding', insertSql, insertSqlValues);
...
IDBObjectStore.prototype.__overwrite = function (tx, key, cb, error) {
    ...
    tx.executeSql(sql, [util.escapeSQLiteStatement(encodedKey)], function (tx, data) {
        CFG_1.default.DEBUG && console.log('Did the row with the', key, 'exist? ', data.rowsAffected);
        cb(tx);
    }, function (tx, err) {
        error(err);
    });
...
IDBObjectStore.prototype.__get = function (query, getKey, getAll, count) {
    ...
    return me.transaction.__addToTransactionQueue(function objectStoreGet(tx, args, success, error) {
        CFG_1.default.DEBUG && console.log('Fetching', me.__currentName, sqlValues);
        tx.executeSql(sql, sqlValues, function (tx, data) {
            CFG_1.default.DEBUG && console.log('Fetched data', data);
            var ret;
            try {
                ...
                CFG_1.default.DEBUG && console.log(e);
            }
            success(ret);
        }, function (tx, err) {
            error(err);
...
IDBObjectStore.prototype.delete = function (query) {
    ...
    return me.transaction.__addToTransactionQueue(function objectStoreDelete(tx, args, success, error) {
        ...
        tx.executeSql(sql, sqlValues, function (tx, data) {
            CFG_1.default.DEBUG && console.log('Deleted from database', data.rowsAffected);
...
IDBObjectStore.prototype.clear = function () {
    ...
    return me.transaction.__addToTransactionQueue(function objectStoreClear(tx, args, success, error) {
        tx.executeSql('DELETE FROM ' + util.escapeStoreNameForSQL(me.__currentName), [], function (tx, data) {
            CFG_1.default.DEBUG && console.log('Cleared all records from database', data.rowsAffected);
            me.__cursors.forEach(function (cursor) {
...
IDBObjectStore.prototype.count = function ( /* query */) {
    ...
    return IDBCursor_1.IDBCursorWithValue.__createInstance(query, 'next', me, me, 'key', 'value', true).__req;
};
IDBObjectStore.prototype.openCursor = function ( /* query, direction */) {
    ...
    IDBObjectStore.__invalidStateIfDeleted(me);
    var cursor = IDBCursor_1.IDBCursorWithValue.__createInstance(query, direction, me, me, 'key', 'value');
...
IDBObjectStore.prototype.openKeyCursor = function ( /* query, direction */) {
    ...
    IDBObjectStore.__invalidStateIfDeleted(me);
    var query = arguments[0], direction = arguments[1];
    var cursor = IDBCursor_1.IDBCursor.__createInstance(query, direction, me, me, 'key', 'key');
    me.__cursors.push(cursor);
    return cursor.__req;
};
IDBObjectStore.prototype.index = function (indexName) {
    ...
    if (!me.__indexHandles[indexName] ||
        ...
        me.__indexHandles[indexName] = IDBIndex_1.IDBIndex.__clone(index, me);
    }
...
IDBObjectStore.prototype.createIndex = function (indexName, keyPath /* , optionalParameters */) {
    ...
    IDBIndex_1.IDBIndex.__createIndex(me, index);
    return index;
};
